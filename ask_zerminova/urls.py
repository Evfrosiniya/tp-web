...
urlpatterns = [
    ...
    url(r'^tag/(?P<page>\d+)/$', 'ask_zerminova.views.tag_index', name='tag_index'),
    ...
    url(r'^question/(?P<id>\d+)/(?P<page>\d+)/$', 'ask_zerminova.views.question', name='question'),
    url(r'^question/(?P<id>\d+)/$', 'ask_zerminova.views.question', name='question'),
